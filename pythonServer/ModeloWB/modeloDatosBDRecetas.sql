...
CREATE TABLE IF NOT EXISTS `bdRecetas`.`Receta` (
  ...
  CONSTRAINT `fk_Receta_Categoria1`
    ...
    REFERENCES `bdRecetas`.`Categoria` (`idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `bdRecetas`.`Receta_has_Ingrediente` (
  ...
  INDEX `fk_Receta_has_Ingrediente_Receta_idx` (`Receta_idReceta` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Receta_has_Ingrediente_Ingrediente1`
    ...
    REFERENCES `bdRecetas`.`Ingrediente` (`idIngrediente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bdRecetas`.`Receta_Favorita` (
  ...
  INDEX `fk_Usuario_has_Receta_Usuario1_idx` (`Usuario_usuario` ASC) VISIBLE,
