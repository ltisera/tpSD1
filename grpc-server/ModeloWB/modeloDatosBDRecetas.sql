...
CREATE TABLE IF NOT EXISTS `bdrecetas`.`comentario` (
  ...
  `ComentarioAlQueResponde` INT NULL,
  PRIMARY KEY (`idComentario`),
  INDEX `fk_Comentario_Receta1_idx` (`Receta_idReceta` ASC) VISIBLE,
  INDEX `fk_Comentario_Usuario1_idx` (`Usuario_usuario` ASC) VISIBLE,
  INDEX `fk_Comentario_Comentario1_idx` (`ComentarioAlQueResponde` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Comentario_Comentario1`
    FOREIGN KEY (`ComentarioAlQueResponde`)
...
CREATE TABLE IF NOT EXISTS `bdrecetas`.`calificacion` (
  ...
  PRIMARY KEY (`Usuario_usuario`, `Receta_idReceta`),
  INDEX `fk_Usuario_has_Receta_Receta2_idx` (`Receta_idReceta` ASC) VISIBLE,
  INDEX `fk_Usuario_has_Receta_Usuario2_idx` (`Usuario_usuario` ASC) VISIBLE,
